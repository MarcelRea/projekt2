...
export function Dashboard() {
   ...
   const getDataOnDate = async (date) => {
          const res = await fetch("https://dashboard-app.herokuapp.com/api/params/search/" + date)
   ...
   const getAllData = async () => {
        const res = await fetch("https://dashboard-app.herokuapp.com/api/params")
        const dataRes = await res.json();
        setDatasets(dataRes);
      }
   ...
   useEffect(() => {
        ...
        const socket = io("https://dashboard-app.herokuapp.com", {
       ...
       const fetchAir = async () => {
           ...
           const currentRes = await fetch("https://dashboard-app.herokuapp.com/api/params/last")
